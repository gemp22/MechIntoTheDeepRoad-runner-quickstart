...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2311.347276; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2409.506386; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 2149.81127; // x position of the perpendicular encoder (in tick units)
    }
