...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 2492.998329616607; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2219.2755928589904; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 2085.4436288865895; // x position of the perpendicular encoder (in tick units)
    }
